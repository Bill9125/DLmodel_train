import os
os.system("python test.py --GT_class 2 --F_type 2D")
...
os.system("python test.py --GT_class 3 --F_type 2D")
...
os.system("python test.py --GT_class 4 --F_type 2D")
...
os.system("python test.py --GT_class 5 --F_type 2D")
